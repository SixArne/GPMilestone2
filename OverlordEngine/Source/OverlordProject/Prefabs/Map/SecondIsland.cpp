#include "stdafx.h"
#include "SecondIsland.h"
#include "Materials/UberMaterial.h"
#include "Materials/Shadow/UberMaterial_Shadow.h"
#include "Materials/Shadow/DiffuseMaterial_Shadow.h"

void SecondIsland::Initialize(const SceneContext&)
{
	...
	UberMaterial_Shadow* pStripes = MaterialManager::Get()->CreateMaterial<UberMaterial_Shadow>();
	...
	UberMaterial_Shadow* pDazzleMaterial = MaterialManager::Get()->CreateMaterial<UberMaterial_Shadow>();
